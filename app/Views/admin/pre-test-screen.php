...
<body class="inter-body learning-color">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="header-bottom header-bottom-2">
                        <h2 class="fw-500 text-white">Pre-Test Data</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pre-test-section pt-25">
        <div class="custom-container">
            <div class="mb-3">
                ...
                <form method="post" action="<?= site_url('pretest/add_question') ?>">
                        ...
                        <div class="question">
                            ...
                            <div class="question-buttons mb-2 d-flex gap-2">
                                <button
                                    ...
                                    Question</button>
                                <a href="<?= base_url('pretest/delete_question/' . $question['id']) ?>"
                                    ...
                                    <?php foreach ($question['options'] as $oIndex => $option): ?>
                                        <div class="option">
                                            ...
                                            <div class="option-buttons">
                                                ...
                                                <a href="<?= base_url('pretest/delete_option/' . $option['id']) ?>"
    ...
    <!-- Pre-test js -->
    <script src="<?= base_url() ?>assets/js/pre-test.js"></script>
</body>
