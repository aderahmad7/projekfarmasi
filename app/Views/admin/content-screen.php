    ...
    <header class="main-header learning-header h-102">
        <div class="custom-container">
            ...
            <div class="header-bottom header-bottom-2">
                <h2 class="fw-500 text-white">Content</h2>
            </div>
        </div>
    </header>
    <!-- header end -->
    ...
    <div class="setting-style-1 pt-25">
        <div class="custom-container">
            ...
            <ul class="menu-setting-list px-0">
                <li>
                    <a href="<?= site_url('admin/pre_test_screen') ?>" class="menu-setting-box">
                ...
                <li>
                    <a href="<?= site_url('admin/post_test_screen') ?>" class="menu-setting-box">
                        <div class="setting-icon">
                ...
                <li>
                    <a href="<?= site_url('admin/course_screen') ?>" class="menu-setting-box">
                        <div class="setting-icon">
