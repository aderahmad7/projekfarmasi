    ...
    <header class="main-header main-header-chat learning-header">
        <div class="custom-container">
            ...
            <div class="profile-container d-flex gap-2 align-items-center">
                <img src="<?= base_url($data_pasien[0]['foto']) ?>" class="img-fluid chat-img-profile" alt="" />
                <div class="profile-info">
                    <h2 class="fw-500 text-white chat-name"><?= $data_pasien[0]['nama'] ?></h2>
                    <p class="text-light mb-0"><?= $data_pasien[0]['pekerjaan'] ?></p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section
        ...
        <div class="chat-card">
            <form enctype="multipart/form-data" id="chat-form" action="<?= site_url('chat/kirim') ?>" method="post"
                ...
                <input type="hidden" name="id_penerima" value="<?= $data_pasien[0]['id_user'] ?>">
