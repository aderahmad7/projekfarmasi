        ...
        <section id="primary_goal">
            <div class="container">
                ...
                <div class="primary_goal-wrap mt-32">
                    <form id="quiz-form" class="primary-form" method="POST" action="<?= base_url('pretest/done') ?>">
                        <?php
                        $i = 0;
                        $idQuestion = [];
                        foreach ($pertanyaan as $p): ?>
                            ...
                            <?php $i++; ?>
                        <?php endforeach; ?>
                        <button class="btn btn-primary mt-32 w-100" name="submit" type="submit">Kirim</button>
                    </form>
